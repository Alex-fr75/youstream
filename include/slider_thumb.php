...
?>
                ...
                <!--/carousel-inner--> <a id="leftcarou" class="left carousel-control" href="#myCarousel" data-slide="prev">‹</a>

                <a id ="rightcarou" class="right carousel-control" href="#myCarousel" data-slide="next">›</a>
            </div>
            <!--/myCarousel-->
